...
def render_stock_forecast_chart(data, msku):
    ...
    TIME_PERIODS = [
        {"start": datetime(2026, 10, 16), "end": datetime(2026, 11, 15), "coefficient": 1},
        {"start": datetime(2026, 11, 16), "end": datetime(2026, 11, 30), "coefficient": 1},
        {"start": datetime(2026, 12, 1), "end": datetime(2026, 12, 31), "coefficient": 1}
    ]
    forecast_dates = []
    forecast_stock = []

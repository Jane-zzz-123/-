...
def load_and_preprocess_data(file_path):
    ...
    try:
        ...
        required_cols = [
            "MSKU", "品名", "店铺", "记录时间", "日均",
            "7天日均", "14天日均", "28天日均",
            "FBA+AWD+在途库存", "全部总库存", "预计FBA+AWD+在途用完时间",
            "预计总库存用完", "状态判断", "环比上周库存滞销情况变化",
...
def render_product_detail_table(data, prev_data=None, page=1, page_size=30, table_id=""):
    ...
    display_cols = [
        ...
        "FBA+AWD+在途库存", "全部总库存", "预计FBA+AWD+在途用完时间", "预计总库存用完",
        "状态判断", "FBA+AWD+在途滞销数量", "本地滞销数量", "总滞销库存",
...
def main():
    ...
    if df is not None and not df.empty:
        ...
        display_columns = [
            "店铺", "MSKU", "品名", "记录时间", "日均","7天日均","14天日均",
            "28天日均","FBA+AWD+在途库存","全部总库存","预计FBA+AWD+在途用完时间",
            "预计总库存用完","状态判断",
             "预计总库存需要消耗天数", "FBA+AWD+在途滞销数量",
            "本地滞销数量", "总滞销库存",
            "预计总库存需要消耗天数", "预计用完时间比目标时间多出来的天数","环比上周库存滞销情况变化",
